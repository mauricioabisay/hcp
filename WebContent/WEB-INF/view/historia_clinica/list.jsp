...
<table class="table table-hover" style="padding-left:25%; padding-right:25%">
	...
	<tbody>
		...
		<c:if test='${historiaClinicaLegada}'>
			<tr>
				<td><a href="${pageContext.request.contextPath}/historiaclinica/legacy/${paciente.id}">Historia Legada</a></td>
				
				<td>
					<div class="btn-group">
						<a href="${pageContext.request.contextPath}/historiaclinica/legacy/${paciente.id}">
							<button type="button" class="btn btn-default btn-sm">
								<span class="glyphicon glyphicon-zoom-in" aria-hidden="true"></span>
							</button>
						</a>
