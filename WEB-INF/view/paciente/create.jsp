...
<form method="post" class="form-horizontal">	
	...
	<fieldset>
		...
		<c:set var="auxDDError"><form:errors path="pacienteForm.day"/></c:set>
		<c:set var="auxMMError"><form:errors path="pacienteForm.month"/></c:set>
		<c:set var="auxAAAAError"><form:errors path="pacienteForm.year"/></c:set>
		<div class="form-group <c:if test='${( not empty auxDDError || not empty auxMMError || not empty auxAAAAError) }'>has-error</c:if>">
			...
			<div class="form-inline col-sm-9">
				<div class="input-group">
					<form:input path="pacienteForm.day" class="form-control" placeholder="DD" size="1"
						maxlength="2" />
					<div class="input-group-addon">/</div>
					<form:select path="pacienteForm.month" class="form-control">
					...
					<div class="input-group-addon">/</div>
					<form:input path="pacienteForm.year" class="form-control" placeholder="AAAA"
						size="3" maxlength="4" />
				</div>
			</div>
		</div>
