...
<div class="panel panel-primary">
	...
	<div class="panel-body">
		...
		<div class="col-sm-6 print-column-50 print-left">
			...
			<span class="col-sm-4 text-right no-printable">Indicaciones:</span>
			<pre><span class="print-block" style="font-size: large; font-family: Helvetica Neue,Helvetica,Arial,sans-serif">${prescripcionForm.indicaciones}</span></pre>
		</div>
		...
		<div class="col-sm-6 print-column-50 print-right">
			...
			<c:if test='${prescripcionForm.plantilla==4}'>
		...
		<c:if test='${prescripcionForm.plantilla==4}'>
		<div class="col-sm-12 print-column-100 print-block print-small">
			<p>
				<b>ALIMENTOS PERMITIDOS</b>
			...
			<p>
				<b>BEBIDAS PROHIBIDAS</b>
				Toda clase de vinos dulces y licores así como limonadas azucaradas, cervezas y atoles.
			</p>
		</div>
		</c:if>
		<div class="col-sm-12 print-column-100 print-block print-small text-center">
